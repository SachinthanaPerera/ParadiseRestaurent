    ...
    <section class="site-cover" style="background-image: url(images/bg_3.jpg);" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center site-vh-100">
          <div class="col-md-12">
            <h1 class="site-heading site-animate mb-3">Welcome To Paradise Restaurant</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 site-animate mb-5">
            ...
            <p>Paradise Restaurent is situated near to the Wennappuwa town.</p>

            <p class="mb-4">It has a attractive environment and you can buy your meals in low price.</p>
